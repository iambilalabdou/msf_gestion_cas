...
<?php $__env->startSection('mainContent'); ?>
  ...
  <div class="d-flex gap-4 align-items-center">
    <a class="btn btn-primary" href="<?php echo e(route('orphelins.index')); ?>">
  ...
  <form method="post" action="<?php echo e(route('orphelins.store')); ?>" enctype="multipart/form-data">
    <div class="row">
...
unset($__errorArgs, $__bag); ?>" id="nom" name="nom" placeholder="الاسم الكامل" value="<?php echo e(old('nom')); ?>">
        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="col-sm-4 mb-4">
        ...
        <input type="text" class="form-control" id="nomMere" name="nomMere" placeholder="اسم الأم" value="<?php echo e(old('nomMere')); ?>">
      </div>

      <div class="col-sm-4 mb-4">
        <label for="CINMere" class="form-label">رقم بطاقة الأم</label>
        <input type="text" class="form-control" id="CINMere" name="CINMere" placeholder="رقم بطاقة الأم" value="<?php echo e(old('CINMere')); ?>">
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-4 mb-4">
        ...
        <input type="text" class="form-control" id="telephone" name="telephone" placeholder="رقم الهاتف" value="<?php echo e(old('telephone')); ?>">
      </div>
      <div class="col-sm-4 mb-4">
        <label for="dateNaissance" class="form-label">تاريخ الازدياد</label>
        <input type="date" class="form-control" id="dateNaissance" name="dateNaissance" value="<?php echo e(old('dateNaissance')); ?>">
      </div>
      <div class="col-sm-4 mb-4">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="col-sm-4 mb-4">
        ...
        <input type="number" class="form-control" id="pointure" name="pointure" placeholder="مقاس الحذاء" value="<?php echo e(old('pointure')); ?>">
      </div>
      <div class="col-sm-4 mb-4">
        ...
        <input type="number" class="form-control" id="tailleChemise" name="tailleChemise"
          placeholder="مقاس القميص" value="<?php echo e(old('tailleChemise')); ?>">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-4 mb-4">
        ...
        <select class="form-select" id="niveauScolaire" name="niveauScolaire" value="<?php echo e(old('niveauScolaire')); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\msf_gestion_cas\resources\views/orphelins/create.blade.php ENDPATH**/ ?>